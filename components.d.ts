...
declare function BlogCard({ slug, title, content, heroImageUrl, seoDesc, createdAt, locale, author }: BlogCardProps): react_jsx_runtime.JSX.Element;
...
declare function BlogList({ posts, locale, translations, authors }: BlogListProps): react_jsx_runtime.JSX.Element;
