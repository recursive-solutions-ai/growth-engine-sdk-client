...
function NewsletterContent({ issue, date }) {
  const displayDate = date ?? (issue.sentAt ? new Date(issue.sentAt).toLocaleDateString() : null);
  return /* @__PURE__ */ jsxs10("article", { children: [
    /* @__PURE__ */ jsx12("h1", { className: "text-4xl font-bold mb-2", children: issue.subject }),
    displayDate && /* @__PURE__ */ jsx12("time", { className: "text-sm text-base-content/50", children: displayDate }),
    /* @__PURE__ */ jsx12(
      "div",
      {
