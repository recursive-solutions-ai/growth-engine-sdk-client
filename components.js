...
function buildBlogPostingLd(post, author, business, options) {
  const ld = {
    ...
    ...omitNulls({
      ...
      // The canonical URL of this article — ties the structured data to the
      // same URL as the <link rel="canonical"> and sitemap entry.
      url: options?.url ?? null,
      mainEntityOfPage: options?.url ? { "@type": "WebPage", "@id": options.url } : null,
...
function BlogContent({
  ...
  const jsonLd = post && !disableJsonLd ? buildBlogPostingLd(post, author, business, canonicalUrl ? { url: canonicalUrl } : void 0) : null;
...
function FormRenderer({ form, translations, onSubmitSuccess }) {
  ...
  return /* @__PURE__ */ jsxs8("div", { className: "mx-auto max-w-lg", children: [
    ...
    /* @__PURE__ */ jsxs8("form", { onSubmit: handleSubmit, className: "mt-8 space-y-4", children: [
      ...
      showNewsletterOptIn && /* @__PURE__ */ jsx10("div", { className: "form-control w-full", children: /* @__PURE__ */ jsxs8("label", { className: "label cursor-pointer justify-start gap-3", children: [
        /* @__PURE__ */ jsx10(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ jsx10("span", { className: "label-text", children: formSettings?.newsletterOptIn?.label ?? DEFAULT_NEWSLETTER_OPT_IN_LABEL })
      ] }) }),
...
function NewsletterSignup({
  ...
  if (subscribed) {
    return /* @__PURE__ */ jsxs9("div", { className: `rounded-xl border bg-base-100 p-6 text-center ${className ?? ""}`.trim(), children: [
      /* @__PURE__ */ jsx11("div", { className: "mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-success/20", children: /* @__PURE__ */ jsx11("svg", { className: "h-5 w-5 text-success", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx11("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) }) }),
      /* @__PURE__ */ jsx11("p", { className: "font-semibold", children: successMessage })
    ] });
  }
  return /* @__PURE__ */ jsxs9("div", { className: `rounded-xl border bg-base-100 p-6 ${className ?? ""}`.trim(), children: [
    title && /* @__PURE__ */ jsx11("h2", { className: "text-xl font-semibold", children: title }),
    description && /* @__PURE__ */ jsx11("p", { className: "mt-1 text-base-content/60", children: description }),
    /* @__PURE__ */ jsxs9("form", { onSubmit: handleSubmit, className: "mt-4 space-y-3", children: [
      collectName && /* @__PURE__ */ jsx11(
        "input",
        {
          type: "text",
          value: name,
      ...
      error && /* @__PURE__ */ jsx11("p", { className: "text-sm text-error", children: error }),
      /* @__PURE__ */ jsx11("button", { type: "submit", disabled: submitting, className: "btn btn-primary w-full", children: submitting ? "Subscribing..." : buttonLabel })
    ] })
  ] });
}
...
function NewsletterUnsubscribe({
  ...
  if (done) {
    return /* @__PURE__ */ jsxs10("div", { className: `rounded-xl border bg-base-100 p-6 text-center ${className ?? ""}`.trim(), children: [
      ...
      successHint && /* @__PURE__ */ jsx12("p", { className: "mt-1 text-sm text-base-content/60", children: successHint })
    ] });
  }
  return /* @__PURE__ */ jsxs10("div", { className: `rounded-xl border bg-base-100 p-6 ${className ?? ""}`.trim(), children: [
    ...
    /* @__PURE__ */ jsxs10("form", { onSubmit: handleSubmit, className: "mt-4 space-y-3", children: [
      ...
      /* @__PURE__ */ jsx12("button", { type: "submit", disabled: submitting, className: "btn btn-primary w-full", children: submitting ? "Removing..." : buttonLabel })
    ] })
  ] });
}
...
function NewsletterContent({ issue, date }) {
  ...
  return /* @__PURE__ */ jsxs11("article", { children: [
    /* @__PURE__ */ jsx13("h1", { className: "text-4xl font-bold mb-2", children: issue.subject }),
    displayDate2 && /* @__PURE__ */ jsx13("time", { className: "text-sm text-base-content/50", children: displayDate2 }),
    /* @__PURE__ */ jsx13(
      "div",
      {
        className: "prose prose-lg max-w-none mt-6",
        dangerouslySetInnerHTML: {
          __html: marked2.parse(issue.content, { async: false })
        }
      }
    )
  ] });
...
function UpdatesFeed({
  ...
  if (error) {
    return /* @__PURE__ */ jsx14("section", { className, "aria-label": list?.name ?? "Updates", children: /* @__PURE__ */ jsx14("p", { className: "text-error", role: "alert", children: error }) });
  }
  return /* @__PURE__ */ jsxs12("section", { className, "aria-label": list?.name ?? "Updates", "aria-busy": loading, children: [
    loading && /* @__PURE__ */ jsx14("p", { className: "text-base-content/50", children: t.loadingLabel }),
    !loading && items.length === 0 && /* @__PURE__ */ jsx14("p", { className: "text-base-content/50", children: t.emptyMessage }),
    items.length > 0 && /* @__PURE__ */ jsx14("ul", { className: "flex flex-col gap-8 list-none p-0 m-0", children: items.map((item) => /* @__PURE__ */ jsx14("li", { children: renderItem ? renderItem(item) : /* @__PURE__ */ jsx14(UpdateItemCard, { item, locale }) }, item.id)) })
  ] });
}
function UpdateItemCard({ item, locale }) {
  const date = displayDate(item);
  return /* @__PURE__ */ jsxs12("article", { children: [
    item.imageUrl && /* @__PURE__ */ jsx14("figure", { className: "aspect-video overflow-hidden mb-3", children: /* @__PURE__ */ jsx14("img", { src: item.imageUrl, alt: item.title, className: "w-full h-full object-cover" }) }),
    /* @__PURE__ */ jsx14("h3", { className: "text-xl font-semibold", children: item.title }),
    date && /* @__PURE__ */ jsx14("time", { className: "text-sm text-base-content/50", dateTime: new Date(date).toISOString(), children: formatDate2(date, locale) }),
    item.body && /* @__PURE__ */ jsx14(
      "div",
      {
        className: "prose max-w-none mt-2",
        dangerouslySetInnerHTML: {
          __html: marked3.parse(item.body, { async: false })
        }
      }
    )
  ] });
