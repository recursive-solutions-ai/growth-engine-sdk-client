...
function NewsletterContent({ issue, date }) {
  ...
  return /* @__PURE__ */ jsxs10("article", { children: [
    /* @__PURE__ */ jsx12("h1", { className: "text-4xl font-bold mb-2", children: issue.subject }),
    displayDate2 && /* @__PURE__ */ jsx12("time", { className: "text-sm text-base-content/50", children: displayDate2 }),
    /* @__PURE__ */ jsx12(
      "div",
      {
...
function UpdatesFeed({
  ...
  if (error) {
    return /* @__PURE__ */ jsx13("section", { className, "aria-label": list?.name ?? "Updates", children: /* @__PURE__ */ jsx13("p", { className: "text-error", role: "alert", children: error }) });
  }
  return /* @__PURE__ */ jsxs11("section", { className, "aria-label": list?.name ?? "Updates", "aria-busy": loading, children: [
    loading && /* @__PURE__ */ jsx13("p", { className: "text-base-content/50", children: t.loadingLabel }),
    !loading && items.length === 0 && /* @__PURE__ */ jsx13("p", { className: "text-base-content/50", children: t.emptyMessage }),
    items.length > 0 && /* @__PURE__ */ jsx13("ul", { className: "flex flex-col gap-8 list-none p-0 m-0", children: items.map((item) => /* @__PURE__ */ jsx13("li", { children: renderItem ? renderItem(item) : /* @__PURE__ */ jsx13(UpdateItemCard, { item, locale }) }, item.id)) })
  ] });
}
function UpdateItemCard({ item, locale }) {
  const date = displayDate(item);
  return /* @__PURE__ */ jsxs11("article", { children: [
    item.imageUrl && /* @__PURE__ */ jsx13("figure", { className: "aspect-video overflow-hidden mb-3", children: /* @__PURE__ */ jsx13("img", { src: item.imageUrl, alt: item.title, className: "w-full h-full object-cover" }) }),
    /* @__PURE__ */ jsx13("h3", { className: "text-xl font-semibold", children: item.title }),
    date && /* @__PURE__ */ jsx13("time", { className: "text-sm text-base-content/50", dateTime: new Date(date).toISOString(), children: formatDate2(date, locale) }),
    item.body && /* @__PURE__ */ jsx13(
      "div",
      {
