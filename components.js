...
function buildArticleLd(article) {
  const node = {
    ...
    ...omitEmpty({
      ...
      keywords: article.keywords && article.keywords.length > 0 ? article.keywords.join(", ") : null
    })
  };
  if (article.url) {
...
function RelatedArticles({
  ...
  return /* @__PURE__ */ jsxs7("aside", { "aria-label": heading, className: "mt-16", children: [
    ...
    cta && /* @__PURE__ */ jsxs7("div", { className: "mt-10 rounded-xl border border-base-200 bg-base-100 p-6 sm:p-8 text-center shadow-sm", children: [
      ctaDescription && /* @__PURE__ */ jsx8("p", { className: "text-base-content/70 mb-4", children: ctaDescription }),
      cta.href.startsWith("/") ? /* @__PURE__ */ jsx8(Link3, { href: cta.href, className: "btn btn-primary btn-lg", children: ctaLabel ?? BOOKING_CTA_DEFAULT_LABEL }) : /* @__PURE__ */ jsx8("a", { href: cta.href, className: "btn btn-primary btn-lg", children: ctaLabel ?? BOOKING_CTA_DEFAULT_LABEL })
    ] })
  ] });
}
