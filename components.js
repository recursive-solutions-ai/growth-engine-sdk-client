...
function LandingPageContent({
  ...
  return /* @__PURE__ */ jsxs7("article", { children: [
    nodes.length > 0 && /* @__PURE__ */ jsx8(JsonLd, { data: nodes }),
    !disableMeta && /* @__PURE__ */ jsx8(
      MetaTags,
      {
...
function BusinessJsonLd({ config, organization }) {
  ...
  if (!ld) return null;
  return /* @__PURE__ */ jsx9(JsonLd, { data: ld });
}
...
function FormCard({ slug, name, description, locale, localePrefix }) {
  ...
  return /* @__PURE__ */ jsx10(
    Link3,
    {
      ...
      children: /* @__PURE__ */ jsxs8("div", { className: "card-body", children: [
        /* @__PURE__ */ jsx10("h2", { className: "card-title", children: name }),
        description && /* @__PURE__ */ jsx10("p", { className: "text-base-content/60", children: description })
      ] })
    }
  );
}
...
function FormRenderer({ form, translations, onSubmitSuccess }) {
  ...
  if (submitted) {
    ...
    return /* @__PURE__ */ jsxs9("div", { className: "mx-auto max-w-lg rounded-xl border bg-base-100 p-8 text-center shadow-lg", children: [
      /* @__PURE__ */ jsx11("div", { className: "mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-success/20", children: /* @__PURE__ */ jsx11("svg", { className: "h-6 w-6 text-success", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx11("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) }) }),
      /* @__PURE__ */ jsx11("h2", { className: "text-xl font-semibold", children: settings2?.successMessage ?? translations?.defaultSuccessMessage ?? "Thank you for your submission!" })
    ] });
  }
  const sortedFields = [...form.fields].sort((a, b) => a.order - b.order);
  const settings = formSettings;
  return /* @__PURE__ */ jsxs9("div", { className: "mx-auto max-w-lg", children: [
    /* @__PURE__ */ jsx11("h1", { className: "text-3xl font-bold", children: form.name }),
    form.description && /* @__PURE__ */ jsx11("p", { className: "mt-2 text-base-content/60", children: form.description }),
    /* @__PURE__ */ jsxs9("form", { onSubmit: handleSubmit, className: "mt-8 space-y-4", children: [
      sortedFields.map((field) => /* @__PURE__ */ jsxs9("div", { className: "form-control w-full", children: [
        /* @__PURE__ */ jsx11("label", { htmlFor: field.name, className: "label", children: /* @__PURE__ */ jsxs9("span", { className: "label-text", children: [
          field.label,
          field.required && /* @__PURE__ */ jsx11("span", { className: "ml-1 text-error", children: "*" })
        ] }) }),
        field.type === "textarea" ? /* @__PURE__ */ jsx11(
          "textarea",
          {
            id: field.name,
          ...
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsx11("option", { value: "", children: field.placeholder ?? "Select..." }),
              (field.options ?? []).map((opt) => /* @__PURE__ */ jsx11("option", { value: opt, children: opt }, opt))
            ]
          }
        ) : field.type === "checkbox" ? /* @__PURE__ */ jsxs9("label", { className: "label cursor-pointer justify-start gap-3", children: [
          /* @__PURE__ */ jsx11(
            "input",
            {
              type: "checkbox",
          ...
          /* @__PURE__ */ jsx11("span", { className: "label-text", children: field.placeholder })
        ] }) : /* @__PURE__ */ jsx11(
          "input",
          {
            type: field.type,
      ...
      showNewsletterOptIn && /* @__PURE__ */ jsx11("div", { className: "form-control w-full", children: /* @__PURE__ */ jsxs9("label", { className: "label cursor-pointer justify-start gap-3", children: [
        /* @__PURE__ */ jsx11(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ jsx11("span", { className: "label-text", children: formSettings?.newsletterOptIn?.label ?? DEFAULT_NEWSLETTER_OPT_IN_LABEL })
      ] }) }),
      error && /* @__PURE__ */ jsx11("div", { className: "alert alert-error", children: /* @__PURE__ */ jsx11("span", { children: error }) }),
      /* @__PURE__ */ jsx11(
        "button",
        {
          type: "submit",
...
function NewsletterSignup({
  ...
  if (subscribed) {
    return /* @__PURE__ */ jsxs10("div", { className: `rounded-xl border bg-base-100 p-6 text-center ${className ?? ""}`.trim(), children: [
      /* @__PURE__ */ jsx12("div", { className: "mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-success/20", children: /* @__PURE__ */ jsx12("svg", { className: "h-5 w-5 text-success", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx12("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) }) }),
      /* @__PURE__ */ jsx12("p", { className: "font-semibold", children: successMessage })
    ] });
  }
  return /* @__PURE__ */ jsxs10("div", { className: `rounded-xl border bg-base-100 p-6 ${className ?? ""}`.trim(), children: [
    title && /* @__PURE__ */ jsx12("h2", { className: "text-xl font-semibold", children: title }),
    description && /* @__PURE__ */ jsx12("p", { className: "mt-1 text-base-content/60", children: description }),
    /* @__PURE__ */ jsxs10("form", { onSubmit: handleSubmit, className: "mt-4 space-y-3", children: [
      collectName && /* @__PURE__ */ jsx12(
        "input",
        {
          type: "text",
          value: name,
      ...
      error && /* @__PURE__ */ jsx12("p", { className: "text-sm text-error", children: error }),
      /* @__PURE__ */ jsx12("button", { type: "submit", disabled: submitting, className: "btn btn-primary w-full", children: submitting ? "Subscribing..." : buttonLabel })
    ] })
  ] });
}
...
function NewsletterUnsubscribe({
  ...
  if (done) {
    return /* @__PURE__ */ jsxs11("div", { className: `rounded-xl border bg-base-100 p-6 text-center ${className ?? ""}`.trim(), children: [
      /* @__PURE__ */ jsx13("div", { className: "mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-success/20", children: /* @__PURE__ */ jsx13("svg", { className: "h-5 w-5 text-success", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx13("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) }) }),
      /* @__PURE__ */ jsx13("p", { className: "font-semibold", children: successMessage }),
      successHint && /* @__PURE__ */ jsx13("p", { className: "mt-1 text-sm text-base-content/60", children: successHint })
    ] });
  }
  return /* @__PURE__ */ jsxs11("div", { className: `rounded-xl border bg-base-100 p-6 ${className ?? ""}`.trim(), children: [
    title && /* @__PURE__ */ jsx13("h2", { className: "text-xl font-semibold", children: title }),
    description && /* @__PURE__ */ jsx13("p", { className: "mt-1 text-base-content/60", children: description }),
    /* @__PURE__ */ jsxs11("form", { onSubmit: handleSubmit, className: "mt-4 space-y-3", children: [
      /* @__PURE__ */ jsx13(
        "input",
        {
          type: "email",
      ...
      error && /* @__PURE__ */ jsx13("p", { className: "text-sm text-error", children: error }),
      /* @__PURE__ */ jsx13("button", { type: "submit", disabled: submitting, className: "btn btn-primary w-full", children: submitting ? "Removing..." : buttonLabel })
    ] })
  ] });
}
...
function NewsletterContent({ issue, date }) {
  ...
  return /* @__PURE__ */ jsxs12("article", { children: [
    /* @__PURE__ */ jsx14("h1", { className: "text-4xl font-bold mb-2", children: issue.subject }),
    displayDate2 && /* @__PURE__ */ jsx14("time", { className: "text-sm text-base-content/50", children: displayDate2 }),
    /* @__PURE__ */ jsx14(
      "div",
      {
...
function UpdatesFeed({
  ...
  if (error) {
    return /* @__PURE__ */ jsx15("section", { className, "aria-label": list?.name ?? "Updates", children: /* @__PURE__ */ jsx15("p", { className: "text-error", role: "alert", children: error }) });
  }
  return /* @__PURE__ */ jsxs13("section", { className, "aria-label": list?.name ?? "Updates", "aria-busy": loading, children: [
    loading && /* @__PURE__ */ jsx15("p", { className: "text-base-content/50", children: t.loadingLabel }),
    !loading && items.length === 0 && /* @__PURE__ */ jsx15("p", { className: "text-base-content/50", children: t.emptyMessage }),
    items.length > 0 && /* @__PURE__ */ jsx15("ul", { className: "flex flex-col gap-8 list-none p-0 m-0", children: items.map((item) => /* @__PURE__ */ jsx15("li", { children: renderItem ? renderItem(item) : /* @__PURE__ */ jsx15(UpdateItemCard, { item, locale }) }, item.id)) })
  ] });
}
function UpdateItemCard({ item, locale }) {
  const date = displayDate(item);
  return /* @__PURE__ */ jsxs13("article", { children: [
    item.imageUrl && /* @__PURE__ */ jsx15("figure", { className: "aspect-video overflow-hidden mb-3", children: /* @__PURE__ */ jsx15("img", { src: item.imageUrl, alt: item.title, className: "w-full h-full object-cover" }) }),
    /* @__PURE__ */ jsx15("h3", { className: "text-xl font-semibold", children: item.title }),
    date && /* @__PURE__ */ jsx15("time", { className: "text-sm text-base-content/50", dateTime: new Date(date).toISOString(), children: formatDate2(date, locale) }),
    item.body && /* @__PURE__ */ jsx15(
      "div",
      {
